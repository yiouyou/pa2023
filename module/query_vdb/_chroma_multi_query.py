...
def get_multi_query_retriever(_db_name):
...
def qa_retriever_multi_query(_query, _db_name):
    ...
    _retriever = get_multi_query_retriever(_db_name)
...
def qa_chroma_multi_query(_query, _db):
    ...
    _ans = qa_retriever_multi_query(_query, _db_name)
    return _ans

def qa_chroma_multi_query_azure(_query):
    _ans, _steps = "", ""
    _ans = qa_chroma_multi_query(_query, "introduction_to_azure_managed_disks")
    return [_ans, _steps]
