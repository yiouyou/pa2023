...
You can [simulate an eviction](/en-us/rest/api/compute/virtualmachines/simulateeviction) of an Azure Spot VM, to test your application response to a sudden eviction.
...
* You can also create an Azure Spot VM using [Azure PowerShell](../windows/spot-powershell) or the [Azure CLI](spot-cli).
* For more information about Azure Spot VM current pricing, see [Azure retail prices API](/en-us/rest/api/cost-management/retail-prices/azure-retail-prices). Both `meterName` and `skuName` contains `Spot`.
* To learn more about an error, see [Error codes](../error-codes-spot).
