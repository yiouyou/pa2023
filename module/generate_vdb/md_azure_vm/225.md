...
For more information, see [Azure VM Image Builder networking options](../linux/image-builder-networking).
...
For more information, see [Configure Azure VM Image Builder permissions by using the Azure CLI](../linux/image-builder-permissions-cli) or [Configure Azure VM Image Builder permissions by using PowerShell](../linux/image-builder-permissions-powershell).
...
Now that the build is finished, you can build a VM from the image. Use the examples from the [PowerShell New-AzVM documentation](/en-us/powershell/module/az.compute/new-azvm#description).
