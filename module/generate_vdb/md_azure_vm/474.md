...
| Command | Notes |
| --- | --- |
| [az snapshot show](/en-us/cli/azure/snapshot) | Gets all the properties of a snapshot using the name and resource group properties of the snapshot. ID property is used to create managed disk. |
| [az disk create](/en-us/cli/azure/disk) | Creates a managed disk using snapshot ID of a managed snapshot |
