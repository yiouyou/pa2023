...
For conceptual information on ZRS, see [Zone-redundant storage for managed disks](disks-redundancy#zone-redundant-storage-for-managed-disks)
...
[![Screenshot of the VM creation workflow, basic pane, redundancy and regions are highlighted.](media/disks-deploy-zrs/disks-zrs-portal-basic.png)](media/disks-deploy-zrs/disks-zrs-portal-basic.png#lightbox)
4. Proceed to the **Disks** pane.
5. Select your disk and select one of the ZRS disks in the drop-down.

[![Screenshot of the vm creation workflow, disks pane, OS disk dropdown is expanded with the ZRS premium SSD and standard SSD options highlighted.](media/disks-deploy-zrs/disks-zrs-portal-select-blade.png)](media/disks-deploy-zrs/disks-zrs-portal-select-blade.png#lightbox)
6. Proceed through the rest of the VM deployment, making any choices that you desire.
...
[![Screenshot of the disk creation workflow, basics pane.](media/disks-deploy-zrs/create-zrs-disk-pane.png)](media/disks-deploy-zrs/create-zrs-disk-pane.png#lightbox)
5. Select one of the available ZRS disks and select **OK**.

[![Screenshot of the disk creation workflow, select a disk size pane, ZRS disks highlighted.](media/disks-deploy-zrs/select-zrs-disk-sku.png)](media/disks-deploy-zrs/select-zrs-disk-sku.png#lightbox)
