...
(DSC) extension handler](dsc-overview). Many of the examples use **RegistrationURL** (provided
as a String) and **RegistrationKey** (provided as a
[PSCredential](/en-us/dotnet/api/system.management.automation.pscredential) to onboard with Azure
Automation. For details about obtaining those values, see
[Use DSC metaconfiguration to register hybrid machines](../../automation/automation-dsc-onboarding#use-dsc-metaconfiguration-to-register-hybrid-machines).
...
[VirtualMachineExtension class](/en-us/dotnet/api/microsoft.azure.management.compute.models.virtualmachineextension).
...
see [VirtualMachineScaleSetExtension class](/en-us/dotnet/api/microsoft.azure.management.compute.models.virtualmachinescalesetextension).
...
[Local Configuration Manager basic settings](/en-us/powershell/dsc/managing-nodes/metaConfig#basic-settings).
...
[DSC extension handler overview](dsc-overview).
...
* Learn about [using virtual machine scale sets with the Azure DSC extension](../../virtual-machine-scale-sets/virtual-machine-scale-sets-dsc).
* Find more details about [DSC's secure credential management](dsc-credentials).
* Get an [introduction to the Azure DSC extension handler](dsc-overview).
